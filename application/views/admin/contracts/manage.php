        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-body _buttons">
                    ...
                    <a href="<?php echo admin_url('contracts/contract'); ?>" class="btn btn-info pull-left display-block"><?php echo _l('new internet package'); ?></a>
                    <?php } ?>
                    ...
                    <div class="row" id="contract_summary">
                        <div class="col-md-12">
                            <h4 class="no-margin text-success"><?php echo _l('internet package_heading'); ?></h4>
                        </div>
